...
window.addEventListener("scroll", ()=>{
  ...
  saluteTextContainer.style.transform= `translateY(${offsetY * .1}px)`
  saluteImgContainer.style.transform= `translate(${offsetY * .4}px, ${offsetY * .7}px)`
  authorName.style.transform= `translateX(calc(-100vh + ${offsetY * .8}px))`
  jobTitleContainers[0].style.backgroundPositionY= `${offsetY * .4}px`
  jobTitleContainers[1].style.backgroundPositionY= `${-offsetY * .2}px`
